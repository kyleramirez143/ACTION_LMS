...
function AddResource({ courseId, module }) {
    async function handleSubmit(e) {
        ...
        formData.append("content_type", "powerpoint");
        ...
        try {
            ...
            if (res.ok) alert("Powerpoint added successfully!");
            else alert(data.error || "Failed to upload");
        } catch (err) {
            console.error(err);
            alert("Error uploading powerpoint");
        }
    }
    ...
    return (
        <div style={styles.page}>
            <div style={styles.card}>
                <h3 style={styles.title}>Add Powerpoint</h3>
                <form onSubmit={handleSubmit}>
                    ...
                    {/* File Title */}
                    <div className="mb-3 row">
                        <label htmlFor="fileTitle" className="col-12 col-sm-2 col-form-label">File Title</label>
                        <div className="col-12 col-sm-8">
                    ...
                    {/* File Description */}
                    <div className="mb-3 row">
                        <label htmlFor="fileDescription" className="col-12 col-sm-2 col-form-label">File Description</label>
                        <div className="col-12 col-sm-8">
