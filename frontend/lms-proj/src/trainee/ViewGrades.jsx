      ...
      <div className="print-area">
        ...
        {activeTab === "Summary of Grades" && (
          <>
            <div className="table-responsive shadow-sm">
                <h5 className="fw-bold mb-2">Summary of Grades</h5>
            ...
            {/* DETAILS / ATTENDANCE (CENTERED LIKE QUIZZES) */}
              ...
              <table className="table gradeview-table">
                <thead>
                  <tr className="text-center">
                    ...
                    <th>Number of Times Late</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="overall-row text-center">
                    <td className="fw-semibold">Attendance</td>
                    <td>1</td>
                    <td>0</td>
                  </tr>
                </tbody>
        ...
        {activeTab === "Nihongo" && (
          <>
            ...
            <div className="table-responsive shadow-sm">
              <h6 className="fw-bold mb-2 text-center">Quizzes</h6>
              <table className="table gradeview-table">
                <thead>
                  <tr className="text-center">
                    <th>Criteria</th>
